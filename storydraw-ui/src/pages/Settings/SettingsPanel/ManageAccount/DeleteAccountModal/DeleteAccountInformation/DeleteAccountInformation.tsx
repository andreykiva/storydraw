		...
		<>
			...
			<div className={styles.DeleteAccountInformation}>
				<p className={styles.InfoText}>
					Your account will be deactivated for <strong>30 days</strong> and won't be visible to the public. During deactivation,
					you can reactivate your StoryDraw account anytime. After
				...
				<ul className={styles.InfoList}>
					...
					<li>Information that isn't stored in your account, such as direct messages, may still be visible to others</li>
					<li>
						Information that isn't stored on StoryDraw servers, such as drafts, will be removed. You won't be able to download
						such information after deleting your account.
					</li>
