...
import cvcIcon from '@/assets/icons/subscribe/cvc.svg';
...
const CVCCodeInput = ({ error, ...rest }: CVCCodeInputProps) => {
	return (
		<div className={cn(styles.CVCCodeInput, error && styles.WithError)}>
			<Input type="text" inputMode="numeric" autoComplete="billing cc-csc" placeholder="CVC" maxLength={4} error={error} {...rest} />
